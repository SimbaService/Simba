...
public final class DropTable extends AbstractOutputWriter {
	...
	private DropTable(final Builder builder) {
	...
	static DropTable parseFields(final InputReader reader) throws IOException {
		int nextFieldNumber = getNextFieldNumber(reader);
		final DropTable.Builder builder = DropTable.newBuilder();
	...
	public static void setUnknownTagHandler(final UnknownTagHandler unknownTagHandler) {
		DropTable.unknownTagHandler = unknownTagHandler;
	}

	public static DropTable parseFrom(final byte[] data) throws IOException {
		return parseFields(new InputReader(data, unknownTagHandler));
	}

	public static DropTable parseFrom(final InputStream inputStream) throws IOException {
		return parseFields(new InputReader(inputStream, unknownTagHandler));
	}

	public static DropTable parseDelimitedFrom(final InputStream inputStream) throws IOException {
